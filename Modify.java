...
import java.io.*;
import java.sql.*;
class Modify extends Panel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent obj)
	{
		...
		if(ob==b1)
		{
			if(b1.getLabel().equals("Modify"))
			{
				try
				{
					s=Integer.parseInt(JOptionPane.showInputDialog(null,"Enter ID","Account",0));
					...
					if(rs.next())
					{
						...
						b1.setLabel("Update");
						JOptionPane.showMessageDialog(null,"Record Found :\nClick on Update Button","Account",0);
					}
					else
					{
			...
			else
			{
				try
				{
				String a1,a2,a3,a4,a5,a7,a8,a10,e1,e2,e3,e4,e5,e6,e7,e8;
				int a6,a9;
				a1=t1.getText();
				a2=t2.getText();
				a3=t3.getText();
				...
				else
				{
					...
					st.executeUpdate("Update account set fullname='"+a1+"',fathername='"+a2+"',dob='"+a3+"',city='"+a4+"',state='"+a5+"',mobno="+a6+",emailid='"+a7+"',nationality='"+a8+"',bal="+a9+",acctype='"+e1+"',custype='"+e2+"',gender='"+e3+"',maritalstatus='"+e4+"',mo='"+e5+"',sms='"+e6+"',internetbanking='"+e7+"',atm='"+e8+"',address='"+a10+"' where id="+s+"");
					JOptionPane.showMessageDialog(null,"Modified & Updated","Emulation",0);
					t1.setText("");
					t2.setText("");
					t3.setText("");
					t4.setText("");
