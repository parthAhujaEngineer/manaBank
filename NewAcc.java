...
class NewAcc extends Panel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent obj)
	{
		...
		if(ob==b1)
		{
			...
			else
			{
				...
				try
				{
					st.execute("insert into account(fullname,fathername,dob,city,state,mobno,emailid,nationality,bal,acctype,custype,gender,maritalstatus,mo,sms,internetbanking,atm,address)values('"+a1+"','"+a2+"','"+a3+"','"+a4+"','"+a5+"',"+a6+",'"+a7+"','"+a8+"',"+a9+",'"+e1+"','"+e2+"','"+e3+"','"+e4+"','"+e5+"','"+e6+"','"+e7+"','"+e8+"','"+a10+"')");
